{- |
    ...
    Maintainer  :  hsi@informatik.uni-kiel.de
    Stability   :  experimental
    Portability :  portable

    This library contains a definition for representing Curry programs
    in Haskell (type "CurryProg") and I/O actions to read Curry programs and
    transform them into this abstract representation as well as write them to
    a file.
...
{- |Data type for representing statements in do expressions and list
    comprehensions.
-}
data CStatement
...
{- |Read an AbstractCurry file and returns the corresponding AbstractCurry
